    ...
    <div className="min-h-screen bg-gradient-to-b from-[#F5F5F5] to-[#EBEBEB]">
      ...
      <main className="max-w-2xl mx-auto px-4 py-8 space-y-6">
        ...
        <section className="grid grid-cols-2 gap-3 pb-8">
          <div className="bg-[#F0F0F0] rounded-2xl p-4 border border-[#D9D9D9]">
            <p className="text-2xl mb-1">💬</p>
            <p className="text-sm font-bold text-[#111827]">Language</p>
            <p className="text-sm text-[#1F2937] mt-0.5">On track for age</p>
          </div>
          <div className="bg-[#F0F0F0] rounded-2xl p-4 border border-[#D9D9D9]">
            <p className="text-2xl mb-1">🏃</p>
            <p className="text-sm font-bold text-[#111827]">Motor Skills</p>
            <p className="text-sm text-[#1F2937] mt-0.5">Developing well</p>
          </div>
          <div className="bg-[#F0F0F0] rounded-2xl p-4 border border-[#D9D9D9]">
            <p className="text-2xl mb-1">🤝</p>
            <p className="text-sm font-bold text-[#111827]">Social</p>
            <p className="text-sm text-[#1F2937] mt-0.5">Ready to explore</p>
          </div>
          <div className="bg-[#F0F0F0] rounded-2xl p-4 border border-[#D9D9D9]">
            <p className="text-2xl mb-1">🧠</p>
            <p className="text-sm font-bold text-[#111827]">Cognitive</p>
            <p className="text-sm text-[#1F2937] mt-0.5">Growing fast</p>
          </div>
        </section>
