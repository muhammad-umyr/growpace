...
export const ALL_ACTIVITIES: ActivityDef[] = [
  ...
  { emoji: "🎭", title: "Pretend play",        desc: "Boosts imagination & social skills",  tag: "Social",    minMonths: 24, maxMonths: 83 },
  { emoji: "🎲", title: "Simple board games", desc: "Teaches turn-taking",                 tag: "Social",    minMonths: 36, maxMonths: 83 },
